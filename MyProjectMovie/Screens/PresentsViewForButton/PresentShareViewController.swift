//
//  PresentShareViewController.swift
//  MyProjectMovie
//
...
class PresentShareViewController: UIViewController {
    ...
    private lazy var menuHeight = UIScreen.main.bounds.height / 2
    private lazy var isPresenting = false
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PresentShareViewController.handleTap(_:)))
...
extension PresentShareViewController: UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
